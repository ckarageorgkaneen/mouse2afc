...
correct_bias = True
current_stim = 0
experiment_type = ExperimentType.LightIntensity
...
incorrect_choice_signal_type = IncorrectChoiceSignalType.BeepOnWire_1
is_catch = False
is_opto_trial = False
left_bias = 0.5
...
min_sample_type = MinSampleType.AutoIncr
mouse_state = MouseState.FreelyMoving
mouse_weight = None
...
opto_prob = 0
opto_start_delay = 0
opto_start_state_1 = MatrixState.stimulus_delivery
pc_timeout = True
percent_50_fifty = 0
percent_catch = 0
...
stim_after_poke_out = StimAfterPokeOut.UntilFeedbackEnd
stim_delay_max = 0
stim_delay_min = 0
...
stimulus_selection_criteria = StimulusSelectionCriteria.DiscretePairs
stimulus_time = 0.3
sum_rates = 100
...
visual_stim_angle_port_left = VisualStimAngle.Degrees270
visual_stim_angle_port_right = VisualStimAngle.Degrees90
